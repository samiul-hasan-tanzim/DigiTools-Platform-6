...
const GetStarted = () => {
    return (
        <div className='container mx-auto bg-gray-50 p-5 mt-50'>
            <h2 className='text-5xl font-extrabold text-center py-5'>Get Started in 3 Steps</h2>
            <p className='text-[#627382] text-center pb-15'>Start using premium digital tools in minutes, not hours.</p>
            <div className='flex justify-between items-center'>
                <div className='flex flex-col justify-center items-center bg-white rounded-2xl space-y-5 p-10  relative'>
